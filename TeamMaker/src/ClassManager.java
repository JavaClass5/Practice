...
public class ClassManager {
    ...
    public void setData() {
        db.insert("우종성", GENDER.MALE, REGION.GYEONGGI, 33, 10);
        db.insert("권오선", GENDER.MALE, REGION.SEOUL, 33, 1);
        db.insert("윤상지", GENDER.MALE, REGION.GYEONGGI, 28, 1);
        db.insert("이강민", GENDER.MALE, REGION.SEOUL, 34, 1);
        db.insert("이윤지", GENDER.FEMALE, REGION.GYEONGGI, 28, 1);
        db.insert("이해성", GENDER.FEMALE, REGION.GYEONGGI, 25, 1);
        db.insert("이현아", GENDER.FEMALE, REGION.GYEONGGI, 26, 1);
        db.insert("이희수", GENDER.FEMALE, REGION.GYEONGGI, 26, 1);
        db.insert("정원우", GENDER.MALE, REGION.GYEONGGI, 26, 8);
        db.insert("조병철", GENDER.MALE, REGION.GYEONGGI, 24, 1);
        db.insert("조정희", GENDER.MALE, REGION.GYEONGGI, 29, 1);
        db.insert("최호열", GENDER.MALE, REGION.GYEONGGI, 31, 1);
    }
    ...
    private void insert() {
        ...
        int age = sc.nextInt();
        System.out.print("[입력 모드] POINT (0 ~ 10) : ");
